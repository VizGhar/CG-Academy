...
private val level2Areas = mapOf("c1" to Area(AreaShape.RECTANGLE, 7.0, 7.0, 9.0, 9.0), "c2" to Area(AreaShape.RECTANGLE, 4.0, 7.0, 6.0, 9.0))
private fun level2Conversations(name: String) = mapOf(
    "c1" to Conversation(
        listOf(
...
fun getLevel2(screenWidth: Int, screenHeight: Int, name: String): Level {
    ...
    return Level(
        ...
        antialias = false,
        areas = level2Areas,
        conversations = level2Conversations(name),
        mapScale = scale,
